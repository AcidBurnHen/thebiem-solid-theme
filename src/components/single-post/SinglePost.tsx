      ...
      return (
        <div class={styles.container}>
          ...
          <div class={styles.single_post}>
            ...
            />
            <h1 class={styles.single_post__title}>{props.postData()?.postBy.title}</h1>
            <div class={styles.single_post__author}>
              <img
                ...
                height={30}
                width={30}></img>
                <Link class={styles.single_post__author_name} href={`/author/${props.postData()?.postBy.author.node.slug}`}>
